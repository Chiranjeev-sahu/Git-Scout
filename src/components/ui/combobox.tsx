...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        "max-h-[min(calc(--spacing(96)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto overflow-x-hidden p-1 data-empty:p-0 scrollbar-thin scrollbar-thumb-zinc-200 scrollbar-track-transparent",
        className
      )}
      {...props}
    />
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "text-black px-2 py-1.5 text-md font-sentient pointer-coarse:px-3 pointer-coarse:py-2 pointer-coarse:text-sm",
        className
      )}
      {...props}
    />
