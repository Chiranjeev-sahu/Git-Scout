      ...
      <header className="sticky top-0 z-50 w-full border-b border-black/5 bg-[#FBFCF8]/80 backdrop-blur-md">
        <div className="flex h-16 items-center justify-between px-6 max-w-7xl mx-auto w-full">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-black tracking-tighter text-zinc-900">Git Scout</span>
          </Link>

          <div className="flex items-center gap-2">
            <Button variant="ghost" className="group rounded-full hover:bg-black/5">
              <Bookmark size={46} className="text-zinc-600 transition-colors group-hover:text-black group-hover:fill-black/10" />
            </Button>
          </div>
        </div>
      </header>
